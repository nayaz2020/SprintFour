...
<div class="container" id="main">
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <!-- Brand/logo -->
        <a class="navbar-brand" href="index.html">KentOutReach</a>
        <!-- Links -->
        <ul class="navbar-nav">
            <li class="nav-item">
    ...
    <div id="coloring" class="jumbotron">
        ...
        <div id ="checkText" class="checkbox">
            <label><input type="checkbox" id="checkbox" value="checkbox" name="checkbox"> I am currently without resident</label>
        </div>
        ...
        <div id = "zip" class = zipdiv>
           ...
           <br>
            ...
            <button id = "zip-btn" type="button" class="btn btn-secondary btn-xs d-none">check zipcode</button>
...
Thrift stores hours tba
            ...
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input"  name='toppings[]' id="id" value="id">
            ...
            <div class="custom-control custom-checkbox">
                ...
                <input type="text" class="form-control"  id="otherInfo" name='otherInfo'  placeholder="Other">
        ...
        <input class = "submit bg-dark text-light" type="submit" value="Submit your request">
